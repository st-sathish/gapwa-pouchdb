var filesToCache = [
  ...
  '/assets/lib/pouchdb.find.js/pouchdb.find.min.js',
  '/assets/lib/pouchdb.relational-pouch.js',
  '/assets/lib/pouchdb.relational-pouch.js/pouchdb.relational-pouch.min.js',
  '/assets/lib/pouchdb.upsert.js/pouchdb.upsert.min.js',
  '/assets/lib/pouchdb-7.1.1.js',
  '/assets/lib/pouchdb-7.1.1.js/pouchdb-7.1.1.js',
  ...
  '/assets/vendor/jquery/jquery.js/jquery.min.js',
  '/assets/vendor/jquery/jquery.min.map',
  '/assets/vendor/jquery/jquery.slim.js',
  '/assets/vendor/jquery/jquery.slim.js/jquery.slim.min.js',
